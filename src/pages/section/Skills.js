...
const Skills = () => {
  const frontSkills = [
    ...
    },
    {
      ...
      title: "Cypress",
      description:
        "Cypress를 이용하여 컴포넌트 테스트 및 e2e 테스트를 할 수 있습니다.",
    },
  ];
  ...
  const backendSkills = [
    {
      ...
      imgAlt: "PostMan",
      title: "PostMan",
      description: "Postman 으로 API 를 테스트할 수 있습니다.",
    },
    {
      imgSrc: springImg,
      imgAlt: "SpringBoot",
      title: "Spring Boot",
      description: "Spring Boot 와 JPA 로 REST API 을 개발할 수 있습니다.",
    },
    {
      imgSrc: oracleImg,
      imgAlt: "Oracle",
  ...
  return (
    <>
      <Section title={"Skills."} content={content} />
    </>
  );
};
